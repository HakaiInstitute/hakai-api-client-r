...
Let's say you're only interested in rerceiving the highest 10 values for chlorophyll from all of the chlorphyll data in the portal. We can do that with the API as well using the sort descending capability and limiting the return to only 10 values.
...
For more great querying capabilities see: https://hakaiinstitute.github.io/hakai-api/querying-data.html
